  ...
  return (
    <section className="max-container">
      ...
      <div className="mt-5 flex flex-col gap-3 text-slate-500">
        <p>
          I've embarked on numerous projects throughtout the years, but these
        ...
        {projects.map((project) => (
          <div className="lg:w-[400px] w-full key={project.name}">
            <div className="block-container w-12 h-12">
              ...
              <div className="btn-front roundded-xl flex- justify-center items-center">
                <img
                  src={project.iconUrl}
                  alt="Project Icon"
                  className="w-1/2 h-1/2 obeject-contain"
                />
              </div>
            </div>
            <div childrenmt-5 flex flex-col>
